...
WATERMARK_TEXT = "Yoonicaps"
WATERMARK_ROTATION = 30
WATERMARK_COLOR = (204, 204, 255, 50)
...
def add_watermark(image, wm_text):
    ...
    draw.text((x, y), wm_text, font=font, fill=WATERMARK_COLOR, stroke_width=3, stroke_fill=(34,2,0,125), anchor='ms')
